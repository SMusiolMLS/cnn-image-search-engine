...
# import vgg and use avg pooling to return a single set of numbers to represent features (one array vs many via max)
...
# set compile = False so we're not retraining the model
